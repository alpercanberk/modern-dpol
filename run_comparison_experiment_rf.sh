...
configs=(
    ...
    # "exp_dec11_unet_rf_lowdim_workspace.yaml"
    "exp_dec12_unet_rf_centered_lowdim_workspace.yaml"
    "exp_dec12_unet_rf_skewright_lowdim_workspace.yaml"
    "exp_dec12_unet_rf_skewleft_lowdim_workspace.yaml"
    "exp_dec12_unet_rf_uniform_lowdim_workspace.yaml"
)
